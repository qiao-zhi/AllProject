...
public class ExportWebExcel extends ActionSupport {
...
//		通过毫秒数获取唯一的名字
		...
		CreteDanXuanTemplate.createDanXuan(wb,danxuan,filepath);
		CreteDuoXuanTemplate.createDuoXuan(wb,duoxuan,filepath);
		CretePanDuanTemplate.createPanDuan(wb,panduan,filepath);
	}
