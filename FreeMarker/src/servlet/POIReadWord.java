...
public class POIReadWord {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream is = new FileInputStream(new File("E:\\EclipseWorkspace\\FreeMarker\\test.doc"));
	...
	/*
	 * @Test1 public void readAndWriterTest3() throws Exception { File file = new
	 * File("E:\\EclipseWorkspace\\FreeMarker\\test.doc"); String str = ""; try
