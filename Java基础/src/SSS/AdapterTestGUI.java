...
public class AdapterTestGUI extends JPanel{
   ...
   private JLabel lblCustomerName, lblAddress,
           lblZip, lblCellphone, lblSSN,emailAddress;
   ...
   private void setUpButtonPanel(){
	  ...
	  emailAddress=new JLabel("EmailAddress:");
	  ...
	  gbc.gridx = 0;
	  gbc.gridy = 5;
	  gridbag.setConstraints(emailAddress, gbc);
	  gbc.gridx = 1;
	  gbc.gridy = 5;
	...
	class ButtonListener implements ActionListener{
       ...
       public void actionPerformed(ActionEvent e){
          ...
          if (e.getActionCommand().equals(VALIDATE)){
             ...
             if(!cusInfo.isValidEmailAddr(email)){dataTextArea.append("\nWrong format of email.");}
