...
public class StudentInfoFacade {
	 ...
	 private final String AWARDS = "E:/EclipseWorkspace/TEST/src/WW/StudentAward.txt";
	 private final String RECORDS = "E:/EclipseWorkspace/TEST/src/WW/StudentAcademicRecord.txt";
	 private final String TUITION = "E:/EclipseWorkspace/TEST/src/WW/Tuition.txt";
  ...
  public String getStudentInfo(){
	    ...
	    if( StudentBasicInfo.isExistingStudentName(nm)==false) {
         ...
         String  tuition=extractTuitionInfo();  //新加代码
 ...
 public String extractAllAwards(){
  ...
  public String extractTuitionInfo(){
  	  ...
  	  ArrayList<StudentTuitionModel> tui = tuition.getAllTution(TUITION);
      Iterator tuitionIterator = tui.iterator(); 
      while (tuitionIterator.hasNext()) {
    	  StudentTuitionModel tuitionModel = (StudentTuitionModel) tuitionIterator.next();

          String firstNm = tuitionModel. getStudFirstName().trim();
          String lastNm = tuitionModel. getStudLastName().trim();
          String  studNum = tuitionModel. getStudSerialNum().trim();
          String tuiNum = tuitionModel.getStudTuitionNum().trim();
          String tuiDate = tuitionModel.getStudTuitionYear().trim();

          allInfo = allInfo +" " + firstNm+" "+ lastNm+ " " + studNum+ " "+ tuiNum+" "+tuiDate+"\n";
 }
 return allInfo;
  }
}
