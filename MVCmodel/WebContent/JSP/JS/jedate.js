...
使用方法:
<script type="text/javascript" src="jedate.js">	</script>		
<input class="datainp" id="datebut" name="birthday" type="text" placeholder="请选择" onClick="jeDate({dateCell:'#datebut',isTime:false,format:'YYYY-MM-DD'})" readonly>
 */
(function(win) {
