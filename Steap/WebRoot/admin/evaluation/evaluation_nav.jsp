...
$(function() {
	...
	$(".updateLoginPass").click(function() {
		...
		$.ajax({
			url: "updateSystemLoginPassAction.action",
			type: "post",
			data: params,
			dataType: "json",
	...
	<div class="header_user">
		<div class="container">
			<div class="header_left">
				<ul class="">
					<li role="presentation" class="active"><a href="admin/evaluation/specialist_evaluation.jsp"><i class="glyphicon glyphicon-home "></i>首页</a></li>
					<li><a href="admin/evaluation/specialistInfo.jsp"><i class="glyphicon glyphicon-cog "></i>个人信息维护</a></li>
					<li><a href="admin/evaluation/evaluatedProject.jsp"><i class="glyphicon glyphicon-folder-open "></i> 待评审项目</a></li>
					<!-- <li><a href="admin/evaluation/pastProject.jsp"><i class="glyphicon glyphicon-folder-close "></i> 已评审项目</a></li> -->
				</ul>
			</div>
			<div class="header_right"  >
				<% 
					Map sessionMap = ActionContext.getContext().getSession();
					String specialistId = (String) sessionMap.get("specialistId");
					String userName = (String) sessionMap.get("userName");
				%>
				<input type="hidden" name="expertId" id="expertId" value="${specialistId }"/>			
				<label>欢迎:</label>
				<span><i class="glyphicon glyphicon-user "></i>专家-${userName}</span>
				<a href="javascript:void(0);" id="update_login_pass" data-toggle="modal" data-target="#fix_login_password_modal">修改密码&nbsp;<i class="glyphicon glyphicon-pencil
						"></i></a>&nbsp;&nbsp;
