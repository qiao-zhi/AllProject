...
<head>
	...
	<script type="text/javascript" src="js/meeting/meetingManage2.js"></script>
...
<body>
	...
	<div class="bread">
		<ol class="breadcrumb">
		  ...
		  <li class="active">验收会议管理</li>
		</ol>	
	</div>
	
	<form action="searchMeetingInfo2.action" method="post">
		...
		<div class="outside_box table_box">
			<div class="btn_box" style="margin-bottom: 8px">
				<button class="btn btn-primary floatL" id="informQY">通知企业</button>
				<button class="btn btn-primary floatL" id="uploadZL">企业准备资料上传</button>
				<button class="btn btn-primary floatL" id="bianzhiZL">资料编制</button>
				<!-- <button class="btn btn-default floatL" id="zhaoKaiMeeting">召开会议</button> -->
				...
				<div class="clear"></div>
				 ...
				 <c:forEach var="meetingInfo" varStatus="status"
					...
					<tr>
						...
						<td>${meetingInfo.meetingPlace}<input id="meetingRemark" type="hidden" value="${meetingInfo.remark }"/></td>
						...
						&meeting.meetingPlace=${meetingInfo.meetingPlace}" class="operation_icon" data-toggle="modal" data-placement="bottom" title="查看"><i class="glyphicon glyphicon-search"></i></a>
						<!-- <a name="updateMeetingInfo2" data-toggle="modal"  href="#myModal"  class="notifyRe">
		      		...
		      		<div class="putIn">
						...
						<label for="">会议信息</label>
		      			...
		      			<div id="meetingBox" class="input_info_group">
								...
								<div class="group_right"><input type="text" class="form-control" name="meeting.hostId"/>
