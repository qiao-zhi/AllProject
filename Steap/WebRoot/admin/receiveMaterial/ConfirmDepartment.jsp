...
<script type="text/javascript"
	src="js/receiveMaterial/ConfirmDepartment.js"></script>
...
<body>
		...
		<div class="modal-dialog" style="width: 700px;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default modal_btn"
						data-dismiss="modal" id="cancelConfirm">取消</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
	...
	<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
		aria-hidden="true" id="basicMessage">
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header word_center my_modal_title">
				...
				<div class="modal-body">
					<div style="margin: 10px auto;">
						...
						<div style="border:none">
								<button class="btn btn-primary" style="margin-left: 56%;margin-top: 5px" id="modifyConfirmB">修改项目负责人</button>
						</div>
