...
<%@page import="com.thinkPro.steap.action.receiveMeterial.execelUtils.ExcelUtilForGetMaterial" %>
...
<%
	...
	String fileName = "接收审查信息导出表.xls";
	response.setHeader("Content-Disposition", "attachment;filename=" + new String(fileName.getBytes("gb2312"), "iso-8859-1"));
	response.setContentType("application/x-download;charset=iso-8859-1");
	OutputStream os = response.getOutputStream(); 
	
	String[] excelHeader = {"会议名称", "项目编号", "申请验收单位", "所属领域", "登记日期", "确定负责部门时间", "领取验收资料时间", "审查时间"};
	String sheetName = "项目基本信息";
	HSSFWorkbook wb = ExcelUtilForGetMaterial.exportExcel(excelHeader, sheetName, result);
	wb.write(os);
%>
</body>
</html>
