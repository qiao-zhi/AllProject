...
<%@page import="com.thinkPro.steap.action.receiveMeterial.execelUtils.ExcelUtilForRegister" %>
...
<%
	...
	HSSFWorkbook wb = ExcelUtilForRegister.exportExcel(excelHeader, sheetName, projects);
	wb.write(os);
%>
</body>
</html>
