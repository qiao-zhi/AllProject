$(document)
		.ready(
				function() {
					...
					$("#saveNoticeToFace")
							.click(
									function() {
										...
										var content = "";
										$(
												"input:checkbox[name='tongxin']:checked")
												.each(
														function() {
															content += $(this)
																	.val()
										...
										// var content = "";
										// var obj =
										// document.getElementsByName("tongxin");
					...
					// 已经保存的通知相关人员信息删除
					$(".deleteNotifydata").click(
							function() {
								var $touched = $(this);
								var deleteNotifyId = $touched.parent()
										.siblings("td:eq(1)").text();
