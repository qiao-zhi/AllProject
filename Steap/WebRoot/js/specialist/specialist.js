...
function show(specialistList) {
	...
	$.each(specialistList, function(i, value) {
		...
		var $majorTD = $("<td/>").text(value.major);
		var $ZJZYTD = $("<td/>").text(value.ZJZY);
		var $telephoneTD = $("<td/>").text(value.telephone);
		var $emailTD = $("<td/>").text(value.email).attr("class","hidden");
		var $degreeTD = $("<td/>").text(value.degree).attr("class","hidden");
		...
		.append($majorTD).append($ZJZYTD).append($telephoneTD).append($emailTD).append($degreeTD).append($operateTD);
...
function infoToInput(click){
	...
	$("#major").val(a.parent().siblings("td:eq(8)").text());
	$("#ZJZY").val(a.parent().siblings("td:eq(9)").text());
	$("#telephone").val(a.parent().siblings("td:eq(10)").text());
	$("#email").val(a.parent().siblings("td:eq(11)").text());
	$("#degree").val(a.parent().siblings("td:eq(12)").text());
}
...
function update(){
	...
	$("#"+id).siblings("td:eq(9)").text($("#email").val());
	$("#"+id).siblings("td:eq(10)").text($("#major").val());
	$("#"+id).siblings("td:eq(11)").text($("#degree").val());
	$("#"+id).siblings("td:eq(12)").text($("#ZJZY").val());
