	...
	<div class="html_middle">
		...
		<div class="main_body">
			...
			<div class="search_bar">
				<div class="input-group search_bar_input floatL" style="width:12%">
					<span class="input-group-addon">姓名</span> <input type="text"
						class="form-control" placeholder="" id="nameCon">
				</div>

				<div class="input-group search_bar_select floatL" style="width:20%">
					<span class="input-group-addon">领域</span> <select
			...
			<div class="table_box outside_box">
				<div class="box_title word_center header_show"><h3>专家管理</h3></div>
				...
				<div class="btn_box">
					<div>
						...
						<button class="btn btn-primary floatR" id="account_add" data-toggle="modal" data-target="" style="width: 150px">创建账户</button>
					</div>
					<div class="clear"></div>
				</div>
				<div>
		      ...
		      <form name="acc" id="form_a" >
			        ...
			        <div class="register_modal_body">
			      		<div class="input_info_group">
			      			...
			      			<div class="group_right">
			      				<input type="text" class="form-control" id="accountId" name="useracc.u_id" readonly="readonly" /><span id="check-tip" style="color:red;"></span> 
			      			</div>
			      			<div class="clear"></div>
			      		</div>
			      		<div class="input_info_group">
			      			...
			      			<div class="group_right">
			      				<input type="text" class="form-control _acc" id="account" name="useracc.userName"/> 
			      			</div>
			      			<div class="clear"></div>
			      		</div>
			      		<div class="input_info_group">
			      ...
			      <div class="modal-footer">	        
			      	<button type="submit"  id="trigger_save_account" class="btn btn-primary modal_btn">保存</button>
			      	<button type="button" id="save_account" class="btn btn-primary modal_btn" style="display:none;">提交</button>
			        <button type="button" id="cancel_save_account" class="btn btn-primary modal_btn" data-dismiss="modal">取消</button>
			      </div>
	     	 </form>
	    </div><!-- /.modal-content -->
	  </div><!-- /.modal-dialog -->
