...
Source Database       : steap_standard

Target Server Type    : MYSQL
Target Server Version : 50629
File Encoding         : 65001

Date: 2016-08-19 22:50:05
*/
...
-- ----------------------------
INSERT INTO `dic_system_dictionary` VALUES ('1', '字典列表', null, '', '字典列表', '0', '0', 'dictionaryList', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('100', '项目状态', '1', '', '项目状态', '0', '0', 'projectStatus', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('100001', '已登记', '100', '', '已登记', '0', '0', 'recorded', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('100002', '已确定验收负责部门', '100', '', '已确定验收负责部门', '0', '0', 'charged', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('100003', '已领取验收项目资料', '100', '', '已领取验收项目资料', '0', '0', 'recieved', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('100004', '已审核', '100', '', '已审核', '0', '0', 'verified', 'varchar', null, null);
...
INSERT INTO `dic_system_dictionary` VALUES ('200', '会议状态', '1', '', '会议状态', '0', '0', 'meetingStatus', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('200001', '准备中', '200', '', '准备中', '0', '0', 'preparing', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('200002', '召开中', '200', '', '召开中', '0', '0', 'holding', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('200003', '已完成', '200', '', '已完成', '0', '0', 'finished', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300', '文件类型', '1', '', '文件类型', '0', '0', 'fileType', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300001', '验收意见初稿', '300', '', '验收意见初稿', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300002', '科技项目验收申请书', '300', '', '科技项目验收申请书', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300003', '承诺书', '300', '', '承诺书', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300004', '计划任务书', '300', '', '计划任务书', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300005', '项目实施工作总结报告', '300', '', '项目实施工作总结报告', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300006', '项目实施技术总结报告', '300', '', '项目实施技术总结报告', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300007', '项目立项后相关证明材料', '300', '', '项目立项后相关证明材料', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('300008', '科技项目验收财务资料一套', '300', '', '科技项目验收财务资料一套', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('400', '图片类型', '1', '', '图片类型', '0', '0', 'pictureType', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('400001', '考察照片', '400', '', '考察照片', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('400002', '廉洁承诺书', '400', '', '廉洁承诺书', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('400003', '真实性承诺书', '400', '', '真实性承诺书', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('500', '机构', '1', '', '机构', '0', '0', 'institution', 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('500001', '专项管理机构业务处室', '500', '', '专项管理机构业务处室', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('500002', '局纪检监察领导', '500', '', '局纪检监察领导', '0', '0', null, null, null, null);
INSERT INTO `dic_system_dictionary` VALUES ('600', '领域', '1', '', '领域', '0', '0', 'domin', 'varchar', '', null);
INSERT INTO `dic_system_dictionary` VALUES ('600001', '能源与节能环保领域', '600', '', '能源与节能环保领域', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('600002', '现代服务业领域', '600', '', '现代服务业领域', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('600003', '交通运输领域', '600', '', '交通运输领域', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('600004', '信息领域', '600', '', '信息领域', '0', '0', null, 'varchar', null, null);
INSERT INTO `dic_system_dictionary` VALUES ('600005', '现代服务业领域', '600', '', '现代服务业领域', '0', '0', null, 'varchar', null, null);
...
-- ----------------------------
INSERT INTO `enterprise_inspect` VALUES ('EI10000001', 'P1000001', 'U100006', '2016-05-19', '该项目验收资料基本合格', '\0', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000002', 'P1000002', 'U100006', '2016-05-22', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000003', 'P1000003', 'U100006', '2016-05-23', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000004', 'P1000004', 'U100006', '2016-05-24', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000005', 'P1000005', 'U100006', '2016-05-26', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000006', 'P1000006', 'U100006', '2016-06-19', '该项目验收资料基本合格', '\0', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000007', 'P1000007', 'U100006', '2016-06-20', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000008', 'P1000008', 'U100006', '2016-06-21', '该项目验收资料基本合格', '\0', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000009', 'P1000009', 'U100006', '2016-06-21', '该项目验收资料基本合格', '', '已提交');
INSERT INTO `enterprise_inspect` VALUES ('EI10000010', 'P1000010', 'U100006', '2016-06-22', '该项目验收资料基本合格', '', '已提交');
...
-- ----------------------------
INSERT INTO `evaluation_result` VALUES ('12ec23cd-f1ff-4a9f-86ad-c9b33fff18c5', 'P1000007', '根据项目验收时，专家提出的修改意见完善相应的资料，完善原则是增加不修改。比如，提出工作报告需要修改，则可以将修改后的工作报告上传到对应项目中，但不覆盖原来的工作报告，其他内容类似。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('21de437c-4b2d-410d-aa29-0f2dc895c5ce', 'P1000004', '根据验收时间、项目名称、项目单位等等条件进行查询，并以列表展示查询结果，列表默认按照验收日期降序显示验收项目基本信息（项目名称、项目单位、项目金额、验收时间等），点击项目名称可以查看详情。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('5d930460-455b-4d74-bdad-3a717754e59a', 'P1000010', '除基本信息外，展示项目的验收材料、验收信息（包括专家组名单、专家意见、项目意见）。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('68a9dcb1-53f1-49e9-b34e-844b7e62587c', 'P1000002', '根据项目验收时，专家提出的修改意见完善相应的资料，完善原则是增加不修改。比如，提出工作报告需要修改，则可以将修改后的工作报告上传到对应项目中，但不覆盖原来的工作报告，其他内容类似。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('791f9ec7-061d-4863-b759-fe0f9d23dfa6', 'P1000009', '根据验收时间、项目名称、项目单位等等条件进行查询，并以列表展示查询结果，列表默认按照验收日期降序显示验收项目基本信息（项目名称、项目单位、项目金额、验收时间等），点击项目名称可以查看详情，', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('b3c06212-704d-49d4-b284-a17a67db08a7', 'P1000008', '根据项目验收时，专家提出的修改意见完善相应的资料，完善原则是增加不修改。比如，提出工作报告需要修改，则可以将修改后的工作报告上传到对应项目中，但不覆盖原来的工作报告，其他内容类似。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('e30a3056-e90d-4e35-8636-1fbb45345bbd', 'P1000003', '根据项目验收时，专家提出的修改意见完善相应的资料，完善原则是增加不修改。比如，提出工作报告需要修改，则可以将修改后的工作报告上传到对应项目中，但不覆盖原来的工作报告，其他内容类似。', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('e93362ad-f2fe-4660-86bd-a09d38cf15a4', 'P1000005', '根据验收时间、项目名称、项目单位等等条件进行查询，并以列表展示查询结果，列表默认按照验收日期降序显示验收项目基本信息（项目名称、项目单位、项目金额、验收时间等），点击项目名称可以查看详情，', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('e9747a8c-4fcd-4d37-90c2-36c63f251d7e', 'P1000006', '根据验收时间、项目名称、项目单位等等条件进行查询，并以列表展示查询结果，列表默认按照验收日期降序显示验收项目基本信息（项目名称、项目单位、项目金额、验收时间等），点击项目名称可以查看详情，', null, '2016-08-04');
INSERT INTO `evaluation_result` VALUES ('f5b73ace-2c7c-41c9-a202-93e68007bc2c', 'P1000001', '根据项目验收时，专家提出的修改意见完善相应的资料，完善原则是增加不修改。比如，提出工作报告需要修改，则可以将修改后的工作报告上传到对应项目中，但不覆盖原来的工作报告，其他内容类似。', null, '2016-08-04');
