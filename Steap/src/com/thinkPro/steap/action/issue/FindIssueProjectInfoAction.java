...
@Component
public class FindIssueProjectInfoAction extends ActionSupport {
	Logger log = Logger.getLogger(FindIssueProjectInfoAction.class);
	...
	public String execute() throws Exception {
		...
		try {
			if(ValidateCheck.isNotNull(projectId)) {
				...
				Map<String, Object> project  = projectService.getIssueProjectInfoByProjectId(condition);
