...
@Component
public class FindBIProjectAction extends ActionSupport {
	Logger log = Logger.getLogger(FindBIProjectAction.class);
	...
	public String execute() throws Exception {
		...
		try {
			if(ValidateCheck.isNotNull(projectId)) {
				Map<String, Object> project = projectService.getBIProjectByProjectId(projectId);
