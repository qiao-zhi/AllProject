...
public class ExcelUtilForProjectInfo {
	
	public static HSSFWorkbook exportExcel(String[] header, String sheetName, List<ProjectInfoResult> projects) throws Exception {
		...
		for(int i = 0; i < size; i++) {
			...
			cell[4].setCellValue(project.getRecordDate());
			cell[5].setCellValue(project.getProjectFunds());
			cell[6].setCellValue(project.getInspectDate());
		}
		return wb;
	}		
}
