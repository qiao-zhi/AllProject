 ...
 *
 */
public class ChineseConvertAll {
	...
	private static ChineseConvertAll chineseConvertAll = new ChineseConvertAll();

	public static ChineseConvertAll getInstance() {
		return chineseConvertAll;
	}
	...
	public static String ConvertAll(String str) {
		return ChineseConvertAll.getInstance().convertAll(str);
	}
