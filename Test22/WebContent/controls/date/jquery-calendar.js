...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:37px;height:28px;line-height:28px"><select id="calendar_hour" style="width:40px">';
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:60px;height:30px"><select id="calendar_newMonth" style="width:60px">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select" style="width:49px;height:30px"><select id="calendar_newYear" style="width:52px">';
