 ...
 * 
 */
@WebServiceClient(name = "PhoneServiceService", targetNamespace = "http://myWebService.ws/", wsdlLocation = "http://127.0.0.1:8888/ws/phoneManager?WSDL")
    ...
    extends Service
{
    ...
    private final static QName PHONESERVICESERVICE_QNAME = new QName("http://myWebService.ws/", "PhoneServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8888/ws/phoneManager?WSDL");
    ...
    public PhoneService getPhoneServicePort() {
        return super.getPort(new QName("http://myWebService.ws/", "PhoneServicePort"), PhoneService.class);
    }
    ...
    public PhoneService getPhoneServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myWebService.ws/", "PhoneServicePort"), PhoneService.class, features);
    }
